...
```
~/golang/src/github.com/RyanConnell/adventofcode/2024/09 (master) » go test
|=====================================================|
...
|=====================================================|
PASS
ok      github.com/RyanConnell/adventofcode/2024/09        0.004s
```
Alternatively you can do this for _all_ days at once by running `go test ./... -v` and then filtering the output a little.
```
~/golang/src/github.com/RyanConnell/adventofcode/2024 (master) » go test ./... -v | grep "|"
|=====================================================|
